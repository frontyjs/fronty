        ...
        function(_dereq_, module, exports) {
          ...
          var executeDispatchesAndRelease = function(event) {
            if (event) {
              ...
              var PluginModule = EventPluginRegistry.getPluginModuleForEvent(
                event
              );
        ...
        function(_dereq_, module, exports) {
          ...
          function transferInto(props, newProps) {
            for (var thisKey in newProps) {
              ...
              if (
                transferStrategy &&
                TransferStrategies.hasOwnProperty(thisKey)
              ) {
        ...
        function(_dereq_, module, exports) {
          ...
          var ReactStateSetters = {
            ...
            createStateKeySetter: function(component, key) {
              // Memoize the setters.
              var cache =
                component.__keySetters || (component.__keySetters = {});
              return (
                cache[key] ||
                (cache[key] = createStateKeySetter(component, key))
              );
            }
          };
          ...
          ReactStateSetters.Mixin = {
            ...
            createStateSetter: function(funcReturningState) {
              return ReactStateSetters.createStateSetter(
                this,
                funcReturningState
              );
            },
        ...
        function(_dereq_, module, exports) {
          ...
          var ReactTestUtils = {
            ...
            findRenderedDOMComponentWithTag: function(root, tagName) {
              var all = ReactTestUtils.scryRenderedDOMComponentsWithTag(
                root,
                tagName
              );
              if (all.length !== 1) {
             ...
             */
            simulateNativeEventOnNode: function(
              topLevelType,
              node,
              fakeNativeEvent
            ) {
      ...
      170: [
        function(_dereq_, module, exports) {
          ...
          function update(value, spec) {
            ...
            for (var k in spec) {
              if (
                !(ALL_COMMANDS_SET.hasOwnProperty(k) && ALL_COMMANDS_SET[k])
              ) {
