        ...
        (function(global) {
          ...
          Zone.prototype = {
            ...
            removeEventListener: function() {
              return this[keys.common.removeEventListener].apply(
                this,
                arguments
              );
            }
    ...
    6: [
      function(require, module, exports) {
        ...
        function isUnconfigurable(obj, prop) {
          return (
            obj && obj[unconfigurablesKey] && obj[unconfigurablesKey][prop]
          );
        }
            ...
            fnNames.forEach(function(name) {
              ...
              if (delegate) {
                global.zone[name] = function(fn) {
                  var callZone = global.zone.isRootZone()
                    ? global.zone.fork()
                    : global.zone;
                  if (fn) {
                    arguments[0] = function() {
        ...
        (function(global) {
          ...
          function patchClass(className) {
            ...
            global[className].prototype.disconnect = function() {
              var result = this[originalInstanceKey].disconnect.apply(
            ...
            global[className].prototype.observe = function() {
              ...
              return this[originalInstanceKey].observe.apply(
                this[originalInstanceKey],
                arguments
              );
            };
    ...
    14: [
      function(require, module, exports) {
        (function(global) {
          ...
          var _redefineProperty = require('./define-property')
            ._redefineProperty;
          var utils = require('../utils');
          ...
          function apply() {
            if (
              utils.isWebWorker() ||
              !('registerElement' in global.document)
            ) {
              return;
            }
                ...
                callbacks.forEach(function(callback) {
                  if (opts.prototype.hasOwnProperty(callback)) {
                    ...
                    if (descriptor && descriptor.value) {
                      ...
                      opts.prototype[callback] = global.zone.bind(
        ...
        (function(global) {
          ...
          function apply() {
            ...
            global.WebSocket = function(a, b) {
              ...
              var onmessageDesc = Object.getOwnPropertyDescriptor(
                socket,
                'onmessage'
              );
              ...
              utils.patchProperties(proxySocket, [
                'onclose',
                'onerror',
                'onmessage',
                'onopen'
        ...
        (function(global) {
          ...
          function patchEventTargetMethods(obj) {
            ...
            obj.addEventListener = function(eventName, handler, useCapturing) {
              ...
              if (
                handler &&
                handler.toString() !== '[object FunctionWrapper]'
              ) {
                var eventType =
                  eventName + (useCapturing ? '$capturing' : '$bubbling');
                var fn;
                ...
                handler[boundFnsKey][eventType] =
                  handler[boundFnsKey][eventType] || zone.bind(fn);
            ...
            obj.removeEventListener = function(
              ...
              // see https://github.com/angular/zone.js/issues/190
              var target = this || global;
              var result = global.zone.removeEventListener.apply(
                target,
                arguments
              );
              return result;
          ...
          (function() {
            ...
            function lib$es6$promise$asap$$attemptVertx() {
              try {
                var r = require;
                var vertx = r('vertx');
                lib$es6$promise$asap$$vertxNext =
            ...
            function lib$es6$promise$$internal$$handleOwnThenable(
              ...
              if (thenable._state === lib$es6$promise$$internal$$FULFILLED) {
                ...
                thenable._state === lib$es6$promise$$internal$$REJECTED
              ) {
            ...
            function lib$es6$promise$$internal$$fulfill(promise, value) {
              ...
              if (promise._subscribers.length !== 0) {
                lib$es6$promise$asap$$asap(
                  lib$es6$promise$$internal$$publish,
                  promise
                );
              }
            }
            ...
            function lib$es6$promise$$internal$$subscribe(
              ...
              subscribers[
                length + lib$es6$promise$$internal$$FULFILLED
              ] = onFulfillment;
              subscribers[
                length + lib$es6$promise$$internal$$REJECTED
              ] = onRejection;
            ...
            function lib$es6$promise$$internal$$initializePromise(
              promise,
              resolver
            ) {
              try {
            ...
            function lib$es6$promise$enumerator$$Enumerator(
              Constructor,
              input
            ) {
              var enumerator = this;
              ...
              enumerator.promise = new Constructor(
            ...
            lib$es6$promise$enumerator$$Enumerator.prototype._willSettleAt = function(
              ...
              lib$es6$promise$$internal$$subscribe(
                ...
                function(reason) {
                  enumerator._settledAt(
                    lib$es6$promise$$internal$$REJECTED,
                    i,
                    reason
                  );
                }
            ...
            function lib$es6$promise$promise$all$$all(entries) {
              return new lib$es6$promise$enumerator$$default(this, entries)
                .promise;
            }
              ...
              then: function(onFulfillment, onRejection) {
                ...
                if (
                  (state === lib$es6$promise$$internal$$FULFILLED &&
                    !onFulfillment) ||
                  (state === lib$es6$promise$$internal$$REJECTED &&
                    !onRejection)
                ) {
                  return this;
                }
    ...
    1: [
      function(require, module, exports) {
        (function(global) {
          ...
          if (!global.Zone) {
            throw new Error(
              'zone.js should be installed before loading the long stack trace zone'
            );
          }
              ...
              while (currentZone && currentZone.constructedAtException) {
                traces.push(
                  '--- ' +
                    ...
                    ' - ' +
                    (now - currentZone.constructedAtTime) +
                    'ms ago',
...
(function(Reflect) {
  ...
  function decorate(decorators, target, targetKey, targetDescriptor) {
    if (!IsUndefined(targetDescriptor)) {
      ...
      return DecoratePropertyWithDescriptor(
        decorators,
        target,
        targetKey,
        targetDescriptor
  ...
  function DecoratePropertyWithDescriptor(
    decorators,
    target,
    propertyKey,
    descriptor
